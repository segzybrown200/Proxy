...
const conversations: Conversation[] = [
  {
    id: "c1",
    name: "Amina Bello",
    lastMessage: "Thanks! I will ship tomorrow.",
    time: "Oct 12 • 14:23",
    online: true,
  },
  {
    id: "c2",
    name: "John Doe",
    lastMessage: "Can you update the address?",
    time: "Oct 11 • 09:12",
    online: false,
  },
  {
    ...
    <TouchableOpacity
      onPress={() =>
        router.push({
          ...
          params: {
            user: JSON.stringify(user?.data?.user),
            seller: JSON.stringify(item?.user),
          },
        })
      }
    ...
    >
      ...
      <View className="w-12 h-12  relative">
        <Image
          ...
          source={{ uri: item?.user?.kycDocument?.selfieUrl }}
          contentFit="cover"
        />
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View className="items-center mt-8">
            <Text className="text-gray-400 font-RalewayMedium">
              No messages yet.
            </Text>
          </View>
        )}
